...
import { BioProvider } from "@/contex/BioContext";
...
export default function Home() {
  return (
    <main className="relative grid  grid-cols-1 lg:grid-cols-2 gap-12  px-4 py-12 sm:py-16 sm:px-8 md:px-10 slg:p-16 lg:p-24">
